...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonText: "<span class='input-group-text'><a href='' type='button'><i class='fas fa-calendar-alt'></i></a></span>", // Text for trigger button
...
$.extend( Datepicker.prototype, {
	...
	_attachments: function( input, inst ) {
		...
		if ( showOn === "button" || showOn === "both" ) { // pop-up date picker when button clicked
			...
			inst.trigger = $( this._get( inst, "buttonImageOnly" ) ?
				...
				$( "<div class='input-group-append'></div>" ).addClass( this._triggerClass ).
	...
	_generateHTML: function( inst ) {
		...
		prev = ( this._canAdjustMonth( inst, -1, drawYear, drawMonth ) ?
			...
			" title='" + prevText + "'><span class='far fa-arrow-alt-circle-left ui-icon-circle-triangle-" + ( isRTL ? "e" : "w" ) + "'>" + "</span></a>" :
		...
		next = ( this._canAdjustMonth( inst, +1, drawYear, drawMonth ) ?
			...
			" title='" + nextText + "'><span class='far fa-arrow-alt-circle-right ui-icon-circle-triangle-" + ( isRTL ? "w" : "e" ) + "'>" + "</span></a>" :
